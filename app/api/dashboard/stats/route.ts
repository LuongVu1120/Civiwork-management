...
async function handler(_req: NextRequest) {
  ...
  const recent = [
    ...
    ...recentExpenses.map(e => ({ id: e.id, type: 'expense', description: `Chi phí ${e.category}`, date: e.date, amount: e.amountVnd })),
  ...
  return NextResponse.json({
    ...
    totalExpenses,
    totalMaterials,
    netProfit: totalReceipts - totalExpenses - totalMaterials,
    recent
  }, {
